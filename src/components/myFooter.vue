<template>
  <div class="home-about-social">
    <h1 class="foorterHeading">FIND ME <span>ON</span></h1>
  ...
  <div class="footer-copywright">
    <h3><span>Copyright</span> © 2022 all rights reserved</h3>
  </div>
</template>
...
.home-social-icons:hover::before {
  transform: scale(1.1);
  box-shadow: 0 0 15px #00cf5d;
}

.home-social-icons:hover {
  color: #00cf5d;
  box-shadow: 0 0 5px #00cf5d;
  text-shadow: 0 0 2px #00cf5d;
}
